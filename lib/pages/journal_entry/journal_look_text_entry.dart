...
class JournalTextEntry extends StatefulWidget {
  ...
  @override
  State<JournalTextEntry> createState() => _JournalTextEntryState();
}

class _JournalTextEntryState extends State<JournalTextEntry> {
  @override
  void initState() {
    super.initState();
